...
urlpatterns = [
    ...
    path('threads/shared/<str:shared_thread_id>/', views.view_shared_thread, name='view_shared_thread'),
    ...
    path('threads/<int:thread_id>/share/', views.share_thread, name='share_thread'),
